...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post practices_url, params: { practice: { about: @practice.about, end: @practice.end, start: @practice.start, title: @practice.title } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { about: @practice.about, end: @practice.end, start: @practice.start, title: @practice.title } }
